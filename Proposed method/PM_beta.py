...
#PM METHOD WITH BETA CALCULATION
...
for i in range(monte_iter):
    ...
    X_d,qamCons = symbols(n_tx,M_symbols,T_d)
    for tp in range(len(T_p)):      
      ...
      theta_hat_ec = em_pm(Y_d,Y_p,T_d,T_p[tp],Z_p,PsiTilde_td ,M_symbols,varn,itera,h_initial,h,n_tx,partition_r,X_d,qamCons)
